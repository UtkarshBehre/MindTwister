...
/**
 * Created by SomyaMittal on 7/24/2016.
 */
public class SudokuChecker {
    private static SudokuChecker ourInstance = new SudokuChecker();
    ...
    public boolean checkSudoku(int[][] Sudoku) {
        return (checkHorizonal(Sudoku) || checkVertical(Sudoku) || checkRegions(Sudoku));
    }

    private boolean checkHorizonal(int[][] Sudoku) {
        for (int y = 0; y < 9; y++) {
