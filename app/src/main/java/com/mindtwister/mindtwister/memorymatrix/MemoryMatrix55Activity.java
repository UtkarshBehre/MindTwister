...
public class MemoryMatrix55Activity extends AppCompatActivity {
    private final String USERTIME = "User Input Time";
    private final int TOTALTILES = 25;
    private final int TILESTOFLASH = 7;
    private final int CURRENTLEVEL = 5;
    ...
    private int score;
    private String TAG = "VARIBLES CHECK";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_memory_matrix_55);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.memory_matrix55_menu, menu);
        return true;
    }
    ...
    public void checkTileCorrect(int TileNumberClicked, Button tile) {
        ...
        //if tile selected is wrong
             ...
             */
                ...
                Intent previousLevel = new Intent(this, MemoryMatrix45Activity.class);
    ...
    public void checkAllTilesCorrectOrNot() {
        ...
        if (compareNewAndOldGridStates()) {
            ...
            Intent nextLevel = new Intent(this, MemoryMatrix56Activity.class);
