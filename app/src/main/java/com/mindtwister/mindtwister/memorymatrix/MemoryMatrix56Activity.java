...
public class MemoryMatrix56Activity extends AppCompatActivity {
    ...
    private final int TOTALTILES = 30;
    private final int TILESTOFLASH = 8;
    private final int CURRENTLEVEL = 6;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.memory_matrix56_menu, menu);
        return true;
    }
    ...
    public void checkTileCorrect(int TileNumberClicked, Button tile) {
        ...
        //if tile selected is wrong
             ...
             */
                ...
                Intent previousLevel = new Intent(this, MemoryMatrix55Activity.class);
