...
public class MemoryMatrix44Activity extends AppCompatActivity {
    ...
    private final int TILESTOFLASH = 5;
    private final int CURRENTLEVEL = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b13 = (Button) findViewById(R.id.tiles_41_btn);
        buttonsList.add(12, b13);
        Button b14 = (Button) findViewById(R.id.tiles_42_btn);
        buttonsList.add(13, b14);
        Button b15 = (Button) findViewById(R.id.tiles_43_btn);
        buttonsList.add(14, b15);
        Button b16 = (Button) findViewById(R.id.tiles_44_btn);
...
//flashing the tiles for time depending on difficulty
    ...
    public void checkAllTilesCorrectOrNot() {
        ...
        if (compareNewAndOldGridStates()) {
            ...
            Intent nextLevel = new Intent(this, MemoryMatrix45Activity.class);
